...
data = pd.read_csv('/Users/thalleencn/Desktop/k8s-ai/data/k8s_cleaned.csv')
...
# Save the results
data.to_csv('/Users/thalleencn/Desktop/k8s-ai/data/k8s_with_anamolies.csv', index=False)
