...
model = genai.GenerativeModel('models/gemini-1.5-pro')  # Use 'models/gemini-1.5-pro' for higher accuracy

# Load dataset
data_path = "/Users/thalleencn/Desktop/k8s-ai/venv/data/k8s_with_anamolies.csv"
try:
